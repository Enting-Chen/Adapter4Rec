                                ...
                                for drop_rate in drop_rate_list:
                                    for fine_tune_lr in fine_tune_lr_list:
                                        label_screen = '{}_bs{}_ed{}_lr{}_dp{}_L2{}_Flr{}_Blr{}_SASlr{}'.format(
                                            ...
                                            adapter_sasrec_lr)
                                        run_py = "torchrun --nproc_per_node 1 --master_port 1245\
                                                 ...
                                                 --pretrained_model_dir {} --pretrained_model_name {} --finetune_layernorm {} --is_serial {}".format(
