...
adapter_bert_lr_list = [5e-6]
adapter_sasrec_lr_list = [5e-6]
...
# None or True
k_adapter_bert_hidden_dim = 192
is_serial = "True"
adapter_type = "kadapter"
                                ...
                                for drop_rate in drop_rate_list:
                                    for fine_tune_lr in fine_tune_lr_list:
                                        label_screen = '{}_bs{}_ed{}_lr{}_dp{}_L2{}_Flr{}_Blr{}_SASlr{}'.format(
                                            ...
                                            adapter_sasrec_lr)
                                        run_py = "torchrun --nproc_per_node 1 --master_port 1287\
                                                 ...
                                                 --pretrained_model_dir {} --pretrained_model_name {} --finetune_layernorm {} --is_serial {} --adapter_type {} --k_adapter_bert_hidden_dim {}".format(
                                            ...
                                            finetune_layernorm, is_serial, adapter_type, k_adapter_bert_hidden_dim)
                                        os.system(run_py)
