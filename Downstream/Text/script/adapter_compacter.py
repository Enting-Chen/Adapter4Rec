...
pretrained_model_name = 'epoch-53'  # sasrec:epoch-53 cpc:epoch-45
...
adapter_bert_lr_list = [4e-3]
adapter_sasrec_lr_list = [4e-3]
                                ...
                                for drop_rate in drop_rate_list:
                                    for fine_tune_lr in fine_tune_lr_list:
                                        label_screen = '{}_bs{}_ed{}_lr{}_dp{}_L2{}_Flr{}_Blr{}_SASlr{}'.format(
                                            ...
                                            adapter_sasrec_lr)
                                        run_py = "torchrun --nproc_per_node 1 --master_port 1290\
