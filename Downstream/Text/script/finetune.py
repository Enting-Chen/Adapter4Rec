...
adapter_bert_lr_list = [2e-4]
adapter_sasrec_lr_list = [2e-4]
# ['bert','sasrec_all', 'sasrec_first', 'sasrec_last', 'all','None']
adding_adapter_to_list = ['None']
# None or all
                                ...
                                for drop_rate in drop_rate_list:
                                    for fine_tune_lr in fine_tune_lr_list:
                                        ...
                                        run_py = "torchrun --nproc_per_node 1 --master_port 1238\
                                                 ...
                                                 --pretrained_model_dir {} --pretrained_model_name {} --finetune_layernorm {} --is_serial {} --arch {}".format(
                                            ...
                                            finetune_layernorm, is_serial,arch)
                                        os.system(run_py)
